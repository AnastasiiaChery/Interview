...
> Higher abstraction → less infra management, more automation.
...
| Real-time apps / chat | **Firestore** | NoSQL document DB, real-time sync |
...
> Load Balancer = traffic routing, Autoscaling = resource scaling
...
- Analytics / time-series → **Bigtable**  
